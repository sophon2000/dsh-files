...
<p align="center">
  <img src="assets/readme/hero.svg" width="100%" alt="dsh-files: one tool that reads the PDF / DOCX / XLSX the built-in read tool cannot.">
</p>
